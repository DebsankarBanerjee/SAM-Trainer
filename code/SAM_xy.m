...
thr = 400;		% threshold value to binarize image ~ 1500 (450-500 : shashi-LB)
...
pk_prom = 0.65;		% min peak prominence tolerance in FindPeaks ~ 0.45
...
end_ch_high = 800;	% high values representing clogging cells at channel end. Used to calculate bottom line. 
...
fprintf('no of detected cell div = %d\n',divcount)
